...
const G: Record<string, StepGuidanceTe> = {
  ...
  "vrata-katha": {
    keepReady: ["కొన్ని అక్షతలు (చేతిలో పట్టుకోవడానికి)"],
    whatToDo:
      "కింద ఇచ్చిన వినాయక వ్రత కథను మొదటి నుండి చివరి వరకు చదవండి, లేదా " +
      "ఒకరు చదువుతుంటే వినండి. చాలామంది కథ వినేటప్పుడు కొన్ని అక్షతలు చేతిలో " +
      "పట్టుకుని, చివర్లో వాటిని గణేశుని పాదాల దగ్గర ఉంచుతారు.",
    meaning:
