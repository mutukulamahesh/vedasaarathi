...
export const BEGINNER_ACTIONS: readonly BeginnerAction[] = [
  ...
  A("bhuta-shuddhi",
    ...
    "The source states no action; a minimal recitation is used pending reviewer confirmation."),
  A("pranayama",
  ...
  A("yajnopavita",
    ...
    "MINIMAL_LITERAL", [], true,
    "Whether and how a household beginner offers the sacred thread varies; minimal action pending reviewer confirmation."),
  A("gandha",
  ...
  A("anga-puja",
    ...
    "The gesture follows normal akshata/flower offering; touching a fragile murti is a reviewer point."),
  A("ekavimsati-patra-puja",
    ...
    "No automatic flower/akshata substitution is claimed; a reviewed alternative is not yet confirmed."),
  ...
  A("udvasana",
    ...
    "MINIMAL_LITERAL", [VVK], true,
    "The PDF ties Udvasana to the day of immersion; exact timing and action are a reviewer point."),
  A("mangala-shanti",
