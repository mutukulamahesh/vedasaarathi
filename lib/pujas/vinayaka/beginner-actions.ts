...
export const BEGINNER_ACTIONS: readonly BeginnerAction[] = [
  ...
  A("udvasana",
    "Recite the Udvasana verse aloud, with your palms joined and respect.",
    "MINIMAL_LITERAL", [VVK], true,
    "The source gives the verse and ties Udvasana to the day of immersion. Households differ on whether Udvasana is done the same day or on a later immersion day."),
  A("mangala-shanti",
